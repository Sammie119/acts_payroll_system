...
class TeirOneReportExcelExport implements FromCollection, WithHeadings, WithStyles, WithColumnWidths, WithColumnFormatting
{
    ...
    public function headings():array{
        ...
        return [
            [
                'SSNIT 1ST TIER CONTRIBUTION RETURNS FOR '.$date
            ],
            [
                'Staff Name',
                'SSNIT Number',
